                        ...
                        if ($result_cat->num_rows > 0) {
                            while($row = $result_cat->fetch_assoc()) {
                                ...
                                echo '<tr>
                                  ...
                                  <td>'.$status.'</td>
                                  <td>'.$row['ordering'].'</td>
                                  <td> <a href="'.BASE_URL_ADMIN.'cat/edit.php?id='.$row['id'].'" style="padding:2px 10px !important;" class="btn-primary"> Edit </a></td>
                                  <td><a href="'.BASE_URL_ADMIN.'cat/index.php?delete='.$row['id'].'"style="padding:2px 10px !important;" class="btn-danger"> Delete </a></td>
                                </tr>';
                            }
                        }
                    ?>                    
